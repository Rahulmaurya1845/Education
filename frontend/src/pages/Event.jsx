...
// Updated links pointing to EventDetail route
const events = [
  { id: 1, title: 'Tech Future', imgSrc: event1, link: '/highlights/event/tech-future' },
  { id: 2, title: 'AI Seminar', imgSrc: event2, link: '/highlights/event/ai-seminar' },
  { id: 3, title: 'Innovation Workshop', imgSrc: event3, link: '/highlights/event/innovation-workshop' },
  { id: 4, title: 'New Event', imgSrc: event4, link: '/highlights/event/new-event' },
]
